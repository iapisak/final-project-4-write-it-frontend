...
class Comments extends Component {
    ...
    render() {
        ...
        return <div className="d-flex mb-2 align-items-center">
                    <div className="mx-2">
                        <img src={ userPhoto } alt={ this.props.userSlug } style={{ width: '30px', borderRadius: '50%' }}/>
                    </div>
                    <form className="flex-shrink-1 w-100">
                        ...
                        <div>
                            <button type="submit" className="btn btn-primary p-1 ml-2" onClick={ this.handleSubmit }
                                    disabled={ this.state.disabled } ><small>Summit</small></button>
                        </div>
                        </div>
                    </form>
                </div>
